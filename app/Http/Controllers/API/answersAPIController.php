...
class answersAPIController extends InfyOmBaseController
{
    ...
    {
        /** @var answers $answers */
        $answers = $this->answersRepository->find($id);

        if (empty($answers)) {
            return Response::json(ResponseUtil::makeError('answers not found'), 404);
        }
